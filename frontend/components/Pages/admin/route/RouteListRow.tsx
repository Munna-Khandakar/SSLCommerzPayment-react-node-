    ...
    <>
      <div className="flex items-center justify-between py-3">
        <div className="flex items-center space-x-4">
          <FaRoute className="text-green-900" size={30} />
          <div className="">
            ...
            <div className="mb-1 block text-sm text-gray-600">
              {route?.attributes?.stopages?.data.map((stopage, index) => (
                <span
                  className=" mr-1 rounded-lg bg-green-100 px-2 py-1"
                  key={index}
                >
